...
function afficher(data){
    ...
    gId("circuitTab").innerHTML =  "<img class='schema' id='acceuil' src='img/" + data[0].localisation + ".jpg' alt ='circuit'>";
    gId("circuitPhoto").innerHTML =  "<img class='photo' id='photo' src='img/" + data[0].localisation + "Photo.jpg' alt ='photoCircuit'>";
